...
public class Ports {
	...
	public static final int[] DIO_DriveEncoderR = { 0, 1 };
//	public static final int[] DIO_LiftEncoder   = { 2, 3 };
	
	public static final int[] DIO_SonarFront    = { 6, 7 };
//	public static final int[] DIO_SonarBack     = { 4, 5 };'
	

//	public static final int   DIO_LiftSwitchMax  =  8;
//	public static final int   DIO_LiftSwitchMin  =  9;
//	public static final int   DIO_ClawSwitch     = 10;
