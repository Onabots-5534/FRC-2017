...
public class DigitBoard {
	...
	private static class Board_Task implements Runnable {
		...
		Board_Task(DigitBoard b) { _b = b;          }

		public void run()        { _b.board_task(); }
	}
 ...
 */
	...
	public boolean getALatch()        { return getRawButtonLatch(A_MASK);        }
	
	public boolean getAOnRisingEdge() { return getRawButtonOnRisingEdge(A_MASK); }
	
	public boolean getB()             { return(!_b.get());                       }
	
	public boolean getBLatch()        { return getRawButtonLatch(B_MASK);        }
	
	public boolean getBOnRisingEdge() { return getRawButtonOnRisingEdge(B_MASK); }
	...
	public void writeDigits(String output) {
		...
		for (int i = 0; i < 4; i++) {
			...
			while (/*letter < 32 ||*/ letter == '.') {
				...
				if (letter == '.') {
					if (i != 0) _output_buffer[(4-i)*2+3] |= (byte)0b01000000;
				}
